...
const maxLines = positiveIntEnv('URDR_LOG_MAX_LINES', 5000);
const maxAgeMs = positiveIntEnv('URDR_LOG_MAX_AGE_MS', 24 * 60 * 60 * 1000);
const trimEveryWrites = positiveIntEnv('URDR_LOG_TRIM_EVERY_WRITES', 200);
