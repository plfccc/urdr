...
This guide reflects the current `urdr` source layout, where Telegram, Feishu, and WeChat already share the same `bot/` runtime and only differ in `channels/<name>/`.
